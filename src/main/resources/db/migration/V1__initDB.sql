...
CREATE TABLE ROLES (id bigint NOT null, uid UUID NOT null, name varchar(255),userdefined boolean, description varchar(255), created_at bigint, updated_at bigint, PRIMARY KEY (id));
...
CREATE TABLE Clients(id bigint NOT null, uid UUID NOT null,jobtitle varchar(255),address varchar(255),postalcode varchar(255),fieldofstudy varchar(255),telephone varchar(255));
